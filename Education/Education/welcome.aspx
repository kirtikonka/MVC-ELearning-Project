<%@ Page Title="" Language="C#" MasterPageFile="~/Student.Master" AutoEventWireup="true" CodeBehind="welcome.aspx.cs" Inherits="Education.welcome" %>
            ...
            <div class="row">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="design-tab" data-bs-toggle="tab" data-bs-target="#design-tab-pane" type="button" role="tab" aria-controls="design-tab-pane" aria-selected="true">.NET</button>
                    </li>
                                        ...
                                        <a href="topics-detail.html">
                                            ...
                                            <div class="d-flex">
                                                <div>
                                                    ...
                                                    <p class="mb-0">Learn C# through Masstech Videos</p>
                                                </div>
                                        ...
                                        <a href="topics-detail.html">
                                            ...
                                            <div class="d-flex">
                                                <div>
                                                    ...
                                                    <p class="mb-0">Learn ASP.Net through MAsstech Videos</p>
                                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="custom-block bg-white shadow-lg">
                                        <a href="topics-detail.html">
                                            ...
                                            <div class="d-flex">
                                                <div>
                                                    <h5 class="mb-2">MS SQL</h5>

                                                    <p class="mb-0">Learn MS SQL through Masstech Videos</p>
                                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-3">
                                    <div class="custom-block bg-white shadow-lg">
                                        <a href="topics-detail.html">
                                            <div class="d-flex">
                                                <div>
                                                    <h5 class="mb-2">Core Java</h5>

                                                    <p class="mb-0">Learn Core Java with Masstech Videos</p>
                                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-3">
                                    <div class="custom-block bg-white shadow-lg">
                                        <a href="topics-detail.html">
                                            <div class="d-flex">
                                                <div>
                                                    <h5 class="mb-2">Advance Java</h5>

                                                    <p class="mb-0">Learn Advance Java through Masstech Videos</p>
                                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="custom-block bg-white shadow-lg">
                                        <a href="topics-detail.html">
                                            <div class="d-flex">
                                                <div>
                                                    <h5 class="mb-2">MySql</h5>

                                                    <p class="mb-0">Learn  MySql with Videos</p>
                                                </div>
...
<%--                        <div class="tab-pane fade" id="finance-tab-pane" role="tabpanel" aria-labelledby="finance-tab" tabindex="0">
 ...
 <%--                                <p class="text-white">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Animi vero quisquam, rem assumenda similique voluptas distinctio, iste est hic eveniet debitis ut ducimus beatae id? Quam culpa deleniti officiis autem?</p>--%>
                ...
                <div class="col-12 text-center mt-5">
                    <p class="text-white">
                        Want to learn more?
                     <a href="https://www.youtube.com/@masstechbusinesssolutions/streams" class="btn custom-btn custom-border-btn ms-3">Check out Youtube</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-12 mx-auto">
                    ...
                    <p class="d-flex align-items-center mb-1">
                        ...
                        <a href="tel: 110-220-3400" class="site-footer-link">110-220-3400
                        </a>
                    </p>
